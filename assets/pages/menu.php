        ...
        <div class="col-lg-9">
            <div class="row" id="menu-grid">
                ...
                foreach ($platillos as $platillo) {
                    ...
                    <div class="col-md-4">
                        <div class="card">
                            <img src="<?php echo $platillo['urlimagen']; ?>" class="card-img-top"
                                alt="<?php echo $platillo['nombre']; ?>">
                            <div class="card-body">
                                <h5 class="card-title">
        ...
        <div class="col-lg-3">
            <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasRight">
                ...
                <div class="offcanvas-body">
                    <!-- El contenido del Offcanvas irá aquí -->
                </div>
            </div>
            <button class="btn btn-primary position-fixed bottom-0 end-0" type="button" data-bs-toggle="offcanvas"
